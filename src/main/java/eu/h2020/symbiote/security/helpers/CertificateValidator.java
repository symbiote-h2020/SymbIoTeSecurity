...
public class CertificateValidator {
    ...
    /**
     * TODO R3:
     * - rework so that it doesn't throw an Exception, if must then it should throw a unified Validation Exception
     * (rename the @{@link eu.h2020.symbiote.security.commons.exceptions.custom.ValidationException} and reuse it
     * here)
     * - rework so instead of boolean it return the @{@link ValidationStatus}
    ...
    /**
     * TODO R3 this could also return the @{@link ValidationStatus}
     */
