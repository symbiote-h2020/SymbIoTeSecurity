...
//		
		...
		ValidationStatus val = Testclient.validate(getHomeAMM(TestaamInstanceId), validToken, certificate);
...
//		System.out.println(cert);	
        ...
        result = DummyTokenIssuer.generateJWTToken(userId, attributes, userPublicKey, IssuingAuthorityType.CORE, tokenValidity, deploymentID, aamPublicKey, (PrivateKey)key);
